# Generated by Django 3.2.12 on 2022-03-17 05:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_num', models.CharField(help_text='입력예) 010-1234-1234', max_length=13, validators=[django.core.validators.RegexValidator('^\\d{3}-\\d{3,4}-\\d{4}$', message='오류')])),
